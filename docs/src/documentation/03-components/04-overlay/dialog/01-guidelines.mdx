...
![A dialog with two buttons: agree and cancel.](fileId:fannvRpkOJK6uxxT33EKaa;nodeId:37%3A631)

![A dialog with only one option: agree. There is no way to close/cancel the dialog.](fileId:fannvRpkOJK6uxxT33EKaa;nodeId:37%3A631)
...
![A dialog with a warning in the description stating 'You can't do this' and the button is marked as critical (meaning a destructive action).](fileId:fannvRpkOJK6uxxT33EKaa;nodeId:38%3A665)

![A dialog with no description and actions as normal (even though they are destructive -- asking to remove a traveler).](fileId:fannvRpkOJK6uxxT33EKaa;nodeId:38%3A665)
...
![A dialog with a short title and description.](fileId:fannvRpkOJK6uxxT33EKaa;nodeId:37%3A652)

![A dialog with an title covering three lines and a description with three separate paragraphs.](fileId:fannvRpkOJK6uxxT33EKaa;nodeId:37%3A652)
