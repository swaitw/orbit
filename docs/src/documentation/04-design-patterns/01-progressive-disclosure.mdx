...
<ReactExample name="Slider histogram" />
...
<ReactExample name="Collapse search filter" />
...
<ReactExample name="Popover passengers" />
...
<ReactExample name="PricingTable progressive disclosure" />
...
<ReactExample name="Card expand uncontrolled" />]
